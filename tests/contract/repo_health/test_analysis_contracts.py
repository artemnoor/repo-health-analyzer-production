...
def test_contract_import_does_not_load_api_database_or_analyzer_packages() -> None:
    probe = subprocess.run(
        [
            ...
            "-c",
            (
                "import sys; import repowise.core.repo_health.contracts; "
                "print(any(name == 'fastapi' or name == 'sqlalchemy' or "
                "name.startswith('repowise.core.analysis.health') or "
                "name.startswith('repowise.core.analysis.analyzer_integration') "
